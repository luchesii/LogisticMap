...
file_tocount = np.loadtxt('esn_new_minstable_r3.997_x0.1_f1a40_d200.csv',delimiter=",")
...
for ii in range(file_siz,10000):
    ...
    for fut in range(1,41):
        ...
        file2 = open('esn_new_minstable_r3.997_x0.1_f1a40_d200.csv','a+')
