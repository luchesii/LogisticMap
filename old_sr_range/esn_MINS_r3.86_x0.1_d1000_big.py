...
list_of_x0 = np.loadtxt("esn_random_x0.1_r3.86.csv", delimiter=" ")

menor = np.zeros((4))

#para saber quantos ja tem salvos
file_tocount = np.loadtxt('esn_big_minstable_r3.86_x0.1_d1000.csv',delimiter=",")
file_siz = file_tocount.shape[0]
print(file_siz)


for ii in range(file_siz,5000):
    ...
    file2 = open('esn_big_minstable_r3.86_x0.1_d1000.csv','a+')
